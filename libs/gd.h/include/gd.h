...
namespace gd {
	...
	struct string {
		...
		string(const char* data, size_t size) {
			reinterpret_cast<void* (__thiscall*)(void*, const char*, size_t)>(base + 0xa370)(this, data, size);
		}
		...
		string& operator=(const std::string& other) {
			...
			reinterpret_cast<void* (__thiscall*)(void*, const char*, size_t)>(base + 0xa370)(this, other.c_str(), other.size());
			return *this;
		}
